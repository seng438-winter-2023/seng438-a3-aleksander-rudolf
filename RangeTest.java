...
// Tests for isNaNRange
    ...
    public void expandNullRange() {
        ...
        assertEquals("A new range should be created with a lower bound of -11, and upper bound of 11", expectedRange, Range.expand(null, 1.1, 1.1));
    }
   ...
   public void getLengthLowerIsGreaterThanUpper() {
		   ...
		   Range range = new Range(10, -10);
	       assertEquals("This test is for checking invalid range", IllegalArgumentException.class, range.getLength());
